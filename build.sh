...
#git clone --depth 1 git@gitlab.com:seaside1/crypto-hunters-ar-game/crypto-hunters-mobile-app.git
#git clone --depth 1 git@gitlab.com:seaside1/crypto-hunters-ar-game/crypto-hunters-ar-game.git
